...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/tortoise-orm-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/tortoise-orm-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add tortoise-orm
# for installing globally
pixi global install tortoise-orm
```
...
It is possible to list all of the versions of `tortoise-orm` available on your platform:
...
```
pixi search tortoise-orm --channel conda-forge
```
